	...
	$(window).load(function(e) {
		...
		var showContent = setTimeout(function(){
			...
			$("#wordrotator").wordsrotator({
    			...
    			words: ['we are<br><span class="highlight">creative people</span>', 'we create<br><span class="highlight">awesome product</span>']  	//-- Array of words, it may contain HTML values
			});
